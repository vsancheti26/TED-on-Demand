Goal: Our goal is to develop a software solution that, given a user generated prompt, produces infotainment-type content. The idea is that upon receiving a prompt, the
